...
contract ForwarderFactory {
  ...
  function flushSmartAccountERC20(address farwarder, address tokenAddress, address _to) public  returns(uint256){
  ...
  function flushSmartAccountWithGivenERC20Amount( address farwarder, uint256 amount, address tokenAddress, address _to) public  returns(uint256){
  ...
  function changeSmartAccountOwner(address farwarder, address ownerAddress) public {
